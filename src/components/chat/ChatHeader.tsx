...
const ChatHeader = () => {
  return (
    <div className="border-b bg-indigo-600 text-white p-4 rounded-t-lg flex items-center gap-3">
      ...
      <div className="ml-auto flex gap-2">
        <Link to="/marketplace" className="p-2 hover:bg-white/10 rounded-full flex items-center gap-1" title="Workflow Marketplace">
        ...
        <button className="p-2 hover:bg-white/10 rounded-full" title="Settings">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
